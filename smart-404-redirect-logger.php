 ...
 */
function sfrl_load_textdomain() {
	load_plugin_textdomain( 'smart-404-redirect-logger', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
}
add_action( 'plugins_loaded', 'sfrl_load_textdomain' );
